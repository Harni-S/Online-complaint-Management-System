  ...
  <title>Admin</title>
	...
	<body>
		...
		<h2 style="padding-top:10px;">Complete the In-progress complaint here</h2><hr />
			<form class="forum" method="POST" action="panchayatsolveinpro2.php">
			<h5>USER NAME
				...
				<a class="btn btn-light" style="padding-left:2%;padding-right:2%;margin-left:1%;" href="panchayatadminlogin.php">Back to Portal</a>
			</h3>
			</form>
		</div>
