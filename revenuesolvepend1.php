	...
	<body>
		<nav class="navbar-nav navbar-expand-sm bg-info" style="margin:0px;padding:0px;">
			...
			<img src="images/admin.png" style="border-radius:15%;margin-left:25%;float:left" width="120px" height="140px">
					...
					<a class="btn btn-success" style="float:right;margin:10px;" href="revenueafteradminlogin.php">Back to Dashboard</a>
			</div>
		
		</nav>
		<div class="container">
		<h2 style="padding-top:10px;">Complete the Uncheked complaint here</h2><hr />
			<form class="forum" method="POST" action="revenuesolvepend2.php">
			<h5>USER NAME
				...
				<a class="btn btn-light" style="padding-left:2%;padding-right:2%;margin-left:1%;" href="revenueafteradminlogin.php">Back to Portal</a>
			</h3>
			</form>
		</div>
